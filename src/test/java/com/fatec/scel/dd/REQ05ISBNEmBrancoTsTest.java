...
class REQ05ISBNEmBrancoTsTest {
	...
	public static void inicializa() {
		logger = LogManager.getLogger(REQ05ISBNEmBrancoTsTest.class);
		driver = DriverFactory.getDriver();
		driver.get("https://ts-scel.herokuapp.com");
		js = (JavascriptExecutor) driver;
		try {
			ManipulaExcel.setExcelFile("C:\\Users\\Jonathan\\Downloads\\classes_de_equivalencia.xlsx", "Planilha6");
