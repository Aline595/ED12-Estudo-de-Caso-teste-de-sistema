...
class REQ06SemTituloDoLivroTsTest {
	...
	public static void inicializa() {
		logger = LogManager.getLogger(REQ06SemTituloDoLivroTsTest.class);
		driver = DriverFactory.getDriver();
		driver.get("https://ts-scel.herokuapp.com");
		js = (JavascriptExecutor) driver;
		try {
			ManipulaExcel.setExcelFile("C:\\Users\\Jonathan\\Downloads\\classes_de_equivalencia.xlsx", "Planilha7");
