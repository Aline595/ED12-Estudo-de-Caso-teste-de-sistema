...
class REQ04ISBNComMaisDeQuatroDigitosTsTest {
	...
	public static void inicializa() {
		logger = LogManager.getLogger(REQ04ISBNComMaisDeQuatroDigitosTsTest.class);
		driver = DriverFactory.getDriver();
		driver.get("https://ts-scel.herokuapp.com");
		js = (JavascriptExecutor) driver;
		try {
			ManipulaExcel.setExcelFile("C:\\Users\\Aline\\Downloads\\classes_de_equivalencia.xlsx", "Planilha4");
